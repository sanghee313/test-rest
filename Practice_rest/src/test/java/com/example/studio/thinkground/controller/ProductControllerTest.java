...
import com.example.studio.thinkground.service.impl.ProductServiceimpl;
...
public class ProductControllerTest {
    ...
    //ProductController에서 잡고고 있는 Bea 객체에 대해 Mock 형태의 객체를 생성해줌.
    @MockBean
    ...
    void getProductTest() throws Exception {
        ...
        //given : 목 객체가 특정 해야하는 행위를 정의하는 메소드
